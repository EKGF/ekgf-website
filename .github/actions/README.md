...
**Note**: The shared actions use `cargo-binstall` for installation,
which requires Rust/Cargo. For Node.js projects, this is still the
recommended approach as it provides better caching and consistency.
